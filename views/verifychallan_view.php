            ...
            <aside class="main-sidebar" >
                ...
                <section class="sidebar" >
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview" active>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url('Challanverify'); ?>"><i class="fa fa-bell-o"></i> Challan Verify </a></li>
                    </ol>
                    <br><br>
                    <!--container start-->
                    <div class="login-bg">
                        <div class="container">
                            ...
                            <div class="alert alert-danger" id="bannerd" style="width: 119%; padding: 11px;margin-top: 30px; margin-bottom: -30px; display:none;"><strong><span id="statusd"></span></strong><span id="infod"></span></a></div>
                                <form class="form-signin wow fadeInUp"  method='POST'>
                                    <h2 class="form-signin-heading" style="background:#374850;">verify Challan</h2>
                                    <div class="login-wrap">
                                        <input type="text" class="form-control" name="cnic" id="cnic" placeholder="CNIC (Without dashes)" maxlength="13" autofocus required>
                                        <select name="verif_ytype" style="font-size:12px !important;" id="verify_type"  class="form-control " required>
                                            <option >Select Verify Type</option>
                                            <option value="origional challan">Original Challan</option>
                                            <option value="Bank Scroll">Bank Scroll</option>
                                            <option value="Scan copy">Scan Copy</option>
                                            <option value="Other">Other</option>
                                        </select>
                                        <br>

                                        <button class="btn btn-lg btn-login btn-block" id="verified" style="background:#374850;" type="button">Verified</button>
