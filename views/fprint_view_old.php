                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b>____________________________ <b>
                                                        ...
                                                        Applicant Name
                                                        <small>(In Case of Absence of Father)</small>  <input type="text" size="105" value="<?php echo $data[0]->guardian_name; ?>" disabled>
                                                        <p>Guardian CNIC <small>(In Case of Absence of Father) </small></p> <input type="text" id="gnic" placeholder="XXXXX-XXXXXXX-X" value="<?php echo $data[0]->guardian_cnic; ?>" disabled>
                                                        <p id="ic">Financier Monthly Income <input type="text" disabled></p>
                                                        ...
                                                        <table border="1" id="cad">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $data[0]->grade_matric; ?></td>
                                                                <td><?php echo $data[0]->marks_matric; ?></td>
                                                                <td><?php echo $data[0]->total_matric; ?></td>
                                                                <td><?php echo $data[0]->major_matric; ?></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $data[0]->grade_inter1; ?></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $data[0]->grade_inter2; ?></td>
                                                        ...
                                                        <p id="dt">Do not tear</p>
                                                        <p id="dt2">_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _</p>
                                                        <h1 id="hea" >TO BE FILLED IN BY THE CANDIDATE</h1>
                                                        <h3 id="hea2">Form No.: Admission to BSCS (M/E) 2017</h3>
                                                        <p id="fno">Form No:<b><u> <?php echo $data[0]->register_id; ?></u></b> </p>
                                                        <p id="na">Name Of Applicant: <b><u> <?php echo $data[0]->name; ?></u></b> </p>
                                                        <p id="fna">Father Name     : <b><u> <?php echo $data[0]->father_name; ?></u></b> </p>
                                                        <img id="photod" src="<?php echo base_url('img/user_images/' . $data[0]->image); ?>" height="140px" width="140px">
                                                        <h3 id="date">Date of Entry Test: 9th August 2017 (Sunday) GC University Lahore.</h3>
                                                        <h3 id="date1">(Batch-I: 10:00 a.m. to 11:00 a.m. Batch-II: 01:00 p.m. to 02:00 p.m)</h3>
                                                        <p id="line">__________________________________________________________________________________________________________________________________________</p>
                                                        <h5 id="line2">Note : The candidate must keep this receipt/slip to be produced at the time of Test/Inteview. No entry in the campus will be allowed without this slip.</h5>
                                                        <h5 id="line3">Candidate must report one hour prior to the time of the entry test.</h5>
                                                        <h5 id="line4"><b>Visit http://dcs.gcu.edu.pk for all schedules and results</b></h5>
                                                        <h5 id="line5">
                                                            <b>mail to: dcsinfo@gcu.edu.pk</b></h5>
                                                        <script>
