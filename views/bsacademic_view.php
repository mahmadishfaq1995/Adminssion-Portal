...
<html lang="en">
    <body>
        ...
        <fieldset style="border: 0px solid  !important;" >
            <legend style="font-size:35px; width:35% !important; font-family: Square721 Cn BT;">BS Program</legend>
            <div class="container"> <p style="font-size:16px; padding:10px;">
                    ...
                    BS (CS) Degree program is of 135 credit hours, and spread over 4 years with 2 Semesters in each year. The BS (CS) students are required to complete 135 credit hours followed by a thesis in last 4th year to complete the BS(CS) degree.
                </p>
                <fieldset >
