            ...
            <aside class="main-sidebar" >
                ...
                <section class="sidebar" >
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview" id="notification_reload">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url('Notification'); ?>"><i class="fa fa-bell-o"></i> Notification </a></li>
                    </ol>
                    <br><br>
                    <div class="container">
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Notifications and Updates</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                ...
                                <div class="box-footer clearfix">
                                    <button type="button" class="btn btn-outline-primary btn-md pull-right" onclick="add_new_notice();"> + Add New </button>
                                </div>
                            </div>
                            <!-- /.box -->
