...
<html lang="en">
    ...
    <body>
        ...
        <fieldset style="border: 0px solid  !important;" >
            <legend style="font-size:35px; width:35% !important; font-family: Square721 Cn BT;">Fee Package for MS(CS)</legend>
            <div class="container">
                ...
                <fieldset >
                    <legend>MS(CS) Program</legend>
                    <div class="">
                        <p style="font-size:16px; padding:10px;">
                            <span class="fa fa-angle-right fa-1x"></span> Semester Fee: Rs. 60,000/- per semester for four semesters.  <br>
                            <span class="fa fa-angle-right fa-1x"></span> Admission Fee: Rs. 30,000/- <br>
                        </p>
                    </div>
                </fieldset>
