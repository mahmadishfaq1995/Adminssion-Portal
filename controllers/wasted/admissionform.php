...
class admissionform extends CI_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('admissionformmodel');
    ...
    public function index() {
        ...
        $content['view'] = 'admission_form_view';
    ...
    function store_data() {
        ...
        $data = array('name' => $this->input->get('name'),
            ...
            'gcnic' => $this->input->get('gcnic'),
            'phone_no' => $this->input->get('phoneno'),
        ...
        $result_set = $this->admissionformmodel->insert_data($data, $user_id);
        echo 'done';
        exit;
    }
    ...
    function store_pic() {
        if (0 < $_FILES['file']['error']) {
            ...
            move_uploaded_file($_FILES['file']['tmp_name'], 'g:/xampp/htdocs/DCS/img/user_images/' . $this->session->userdata('id') . '.jpg');
        }
    }
