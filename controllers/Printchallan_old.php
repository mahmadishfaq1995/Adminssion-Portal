...
class printchallan extends CI_Controller {
    ...
    function edit_personal() {
        ...
        foreach ($result as $val) {
            ...
            $output .= '<label>';
            $output .= '<input type = "radio" name = "gender" id = "gender" value = "male" checked> Male';
            $output .= '</label>';
            $output .= '</div>';
            $output .= '<div class = "radio">';
            $output .= '<label>';
            $output .= ' <input type = "radio" name = "gender" id = "gender" value = "female"> Female';
            $output .= ' </label>';
            $output .= '</div>';
            $output .= ' </div>';
            $output .= ' </div>';
            ...
            $output .= ' </div>';
            $output .= ' <div class = "form-group">';
            $output .= ' <label for = "inputPassword3" class = " control-label" style = "margin-top:5px;">Father Name :</label>';
            $output .= ' <div  style = "margin-top:5px;">';
            ...
            $output .= ' </div>';
            $output .= ' <div class = "form-group">';
            $output .= ' <label for = "inputPassword3" class = " control-label" style = "margin-top:5px;">Father CNIC :</label>';
            $output .= ' <div  style = "margin-top:5px;">';
            ...
            $output .= ' </div>';
            $output .= ' <div class = "form-group">';
            $output .= ' <label for = "inputPassword3" class = " control-label" style = "margin-top:5px;">Guardian Name:</label>';
            $output .= ' <div  style = "margin-top:5px;">';
            $output .= ' <input type = "text" class = "form-control" name = "gname" id = "gname" placeholder = "abc xyz"  value="' . $val->guardian_name . '" onKeyPress = "Names();" required >';
            $output .= ' <div id = "error_gname" style = "color:red; display:none;"> * Enter a valid Name *</div>';
            $output .= ' </div >';
            $output .= ' </div>';
            $output .= ' <div class = "form-group" >';
            $output .= ' <label for = "inputPassword3" class = " control-label" style = "margin-top:5px;">Guardian CNIC:</label>';
            $output .= ' <div  style = "margin-top:5px;">';
            $output .= ' <input type = "text" class = "form-control" maxlength = "" name = "gcnic" id = "gcnic1"  value="' . $val->guardian_cnic . '" placeholder = "XXXXX" onKeyPress = "Numeric();" required>';
    ...
    function edit_academic() {
        ...
        foreach ($result as $val) {
            ...
            $output .=' <input type = "text" class = "form-cont" maxlength = "2" id = "grade_matric" name = "grade_matric" value="' . $val->grade_matric . '" placeholder = "Grade i.e A+" required>';
            ...
            $output .=' <input type = "text" class = "form-cont" id = "major_matric" name = "major_matric" value="' . $val->major_matric . '" placeholder = "Major" onKeyPress = "Alpha();" required>';
            $output .=' <div id = "error_major_matric" style = "color:red; display:none;"> * Enter a valid Major *</div>';
            ...
            $output .=' <input type = "text" class = "form-cont" id = "grade_inter1" maxlength = "2" value="' . $val->grade_inter1 . '" name = "grade_inter1" placeholder = "Grade i.e A+">';
            ...
            $output .=' <input type = "text" class = "form-cont" id = "major_inter1" value="' . $val->major_inter1 . '" name = "major_inter1" placeholder = "Major" onKeyPress = "Alpha();" required>';
            $output .=' <div id = "error_major_inter1" style = "color:red; display:none;"> * Enter a valid Major *</div>';

            $output .=' <input type = "text" class = "form-cont" id = "board_inter1" value="' . $val->board_inter1 . '" name = "board_inter1" placeholder = "Board/University" required>';
            $output .=' </div>';
            $output .=' </div><br /><br />';
            $output .=' <div class = "form-group">';
            $output .=' <br /> <br />';
            ...
            $output .=' <input type = "text" class = "form-cont" id = "grade_inter2" value="' . $val->grade_inter2 . '" maxlength = "2" name = "grade_inter2" placeholder = "Grade i.e A+" required >';
    ...
    function save_edit_pinfo() {
        $data = array(
            ...
            'gcnic' => $this->input->get_post('gcnic'),
    ...
    function save_edit_ainfo() {
        $data = array(
            ...
            'mgrade' => $this->input->get_post('mgrade'),
            'mtotal' => $this->input->get_post('mtotal'),
            'mmarks' => $this->input->get_post('mmarks'),
            'mmajor' => $this->input->get_post('mmajor'),
            ...
            'igrade1' => $this->input->get_post('igrade1'),
            ...
            'igrade2' => $this->input->get_post('igrade2'),
